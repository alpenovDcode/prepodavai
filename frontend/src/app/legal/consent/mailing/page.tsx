    ...
    <Card>
      ...
      <CardContent className="prose prose-sm max-w-none dark:prose-invert prose-headings:text-black prose-p:text-black prose-strong:text-black prose-li:text-black prose-a:text-blue-600 text-black">
        ...
        <p>
          ...
          <br />
          в случае нежелания получать рекламную информацию на указанных в настоящем согласии условиях мне следует направить уведомление об отзыве настоящего согласия на адрес электронной почты: <a href="mailto:hello@prrv.pro">hello@prrv.pro</a>.
        </p>

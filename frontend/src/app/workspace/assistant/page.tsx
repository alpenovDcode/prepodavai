...
const personas = [
    ...
    { value: 'copywriter',     label: 'Контент для соцсетей',      desc: 'Посты, биографии, кейсы' },
]
...
const suggestionsByPersona: Record<string, string[]> = {
    ...
    copywriter: [
        ...
        'Кейс ученика: «с тройки до пятёрки за месяц»',
        'Шапка профиля учителя английского языка',

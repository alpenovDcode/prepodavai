    ...
    try {
      ...
      if (verifyResponse.data.success) {
        ...
        if (registerResponse.data.success) {
          ...
          setErrorMessage(verifyResponse.data.error || 'Неверный код')
          // setAttemptsLeft can be added if backend supports it later
          // setAttemptsLeft(verifyResponse.data.attemptsLeft !== undefined ? verifyResponse.data.attemptsLeft : null)
        }
      } catch (error: any) {

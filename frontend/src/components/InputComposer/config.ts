...
export const templates: Record<string, FunctionTemplate> = {
  ...
  unpacking: {
    ...
    fields: [
      {
        key: 'q1',
        label: '1) Что вас подтолкнуло заниматься преподаванием? Какие события? Ситуации? Возможно, знаковое событие, которое стало поворотной точкой',
        type: 'textarea',
        rows: 3,
        placeholder: 'Опишите ваш путь...'
      },
      {
        key: 'q2',
        label: '2) Что вы делаете лучше всего? Что вам дается в преподавании легче и проще всего? Какой деятельностью можете заниматься часами и не уставать?',
        type: 'textarea',
        rows: 3,
        placeholder: 'Ваша суперсила...'
      },
      {
        key: 'q3',
        label: '3) За что вам чаще всего говорят “спасибо” ученики и их родители?',
        type: 'textarea',
        rows: 2,
        placeholder: 'За что благодарят...'
      },
      {
        key: 'q4',
        label: '4) Каким вашим знаниям/достижениям, чаще всего удивляются люди?',
        type: 'textarea',
        rows: 2,
        placeholder: 'Вау-факты...'
      },
      {
        key: 'q5',
        label: '5) Чем вы гордитесь в жизни? (5 достижений, связанных даже косвенно с преподаванием)',
        type: 'textarea',
        rows: 3,
        placeholder: '1. ... 2. ...'
      },
      {
        key: 'q6',
        label: '6) Какие действия вы предприняли для этих 5 достижений?',
        type: 'textarea',
        rows: 3,
      ...
      {
        key: 'q7',
        label: '7) Что уникального, авторского в сфере преподавания, было создано вами? Даже мелочи важны.',
        type: 'textarea',
        rows: 3,
        placeholder: 'Методики, подходы...'
      },
      {
        key: 'q8',
        label: '8) С какими учениками вам нравится заниматься больше всего?',
        type: 'textarea',
        rows: 2,
        placeholder: 'Ваш идеальный ученик...'
      },
      {
        key: 'q9',
        label: '9) Почему именно с этой категорией учеников?',
        type: 'textarea',
        rows: 2,
        placeholder: 'Почему они...'
      },
      {
        key: 'q10',
        label: '10) Какой категории учеников вы можете дать результат самым быстрым и эффективным способом? Почему?',
        type: 'textarea',
        rows: 3,
        placeholder: 'Сегмент для быстрого результата...'
      },
      {
        key: 'q11',
        label: '11) Какие ваши личностные качества больше всего влияют на вашу преподавательскую деятельность?',
        type: 'textarea',
        rows: 2,
        placeholder: 'Качества...'
      },
      {
        key: 'q12',
        label: '12) Какие ошибки вы допускали в своем преподавательском пути, как исправляли их, какие выводы сделали, чтобы их не повторить?',
        type: 'textarea',
        rows: 3,
        placeholder: 'Ошибки и выводы...'
      },
      {
        key: 'q13',
        label: '13) 3 аспекта преподавания, которые вызывают у вас больше всего вдохновения',
        type: 'textarea',
        rows: 2,

...
const LEVELS = [
    { label: '5–6',  value: '6 Класс' },
    { label: '7–8',  value: '8 Класс' },
    { label: '9–11', value: '10 Класс' },
    { label: 'ЕГЭ',  value: 'ЕГЭ' },
]
                ...
                <Card padding="none"
                    ...
                    <div data-tour="preview" className="flex-1 min-h-0 bg-ink-50 overflow-hidden p-6 max-md:p-3">
                        {isGenerating ? (
                            ...
                            // preview-placeholder из прототипа: dashed border, центрированный icon-big, заголовок, подсказка

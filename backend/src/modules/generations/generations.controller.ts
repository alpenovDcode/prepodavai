  ...
  async generateLessonPlanV2(@Request() req: any, @Body() body: Record<string, unknown>) {
    return this.textV2Service.generateLessonPlan(
      this.userId(req),
      {
        ...
        lessonType: body.lessonType ? String(body.lessonType) : undefined,
        workFormat: body.workFormat ? String(body.workFormat) : undefined,
        lessonStyle: body.lessonStyle ? String(body.lessonStyle) : undefined,
        interests: body.interests ? String(body.interests) : undefined,
        depth: body.depth as any,
        extraNotes: body.extraNotes ? String(body.extraNotes) : undefined,
      },
      body.lessonId ? String(body.lessonId) : undefined,
    );
  ...
  async generateVocabularyV2(@Request() req: any, @Body() body: Record<string, unknown>) {
    return this.textV2Service.generateVocabulary(
      this.userId(req),
      {
        ...
        withTranscription: typeof body.withTranscription === 'boolean' ? body.withTranscription : undefined,
        withExample: typeof body.withExample === 'boolean' ? body.withExample : undefined,
        withSynonyms: typeof body.withSynonyms === 'boolean' ? body.withSynonyms : undefined,
        practiceFocus: body.practiceFocus ? String(body.practiceFocus) : undefined,
        extraNotes: body.extraNotes ? String(body.extraNotes) : undefined,
      },
      body.lessonId ? String(body.lessonId) : undefined,
    );

...
6. needsImage=true ставь СТРОГО только на слайдах с layout="image-text" — на других лейаутах нет места под картинку, и она не отобразится. Если визуал нужен — выбирай layout="image-text".
7. На "image-text" слайде needsImage обязательно true. Используй "image-text" не более чем на 40% слайдов.
8. imageHint — короткий английский описательный фрагмент (без слова "prompt").

...
`;
    ...
    const userPrompt = `Сгенерируй HTML-код теста с выбором одного варианта ответа.
...
- Все вопросы — закрытые (только выбор одного из вариантов, никаких открытых вопросов).

...
export class AuthController {
  ...
  async validateInitData(@Body() body: ValidateInitDataDto, @Res({ passthrough: true }) res: Response) {
  ...
  async loginWithApiKey(@Body() body: LoginWithApiKeyDto, @Res({ passthrough: true }) res: Response) {
  ...
  @Post('phone/login')
  @Throttle({ default: { limit: 5, ttl: 60000 } })
  async loginWithPhone(@Body() body: LoginWithPhoneDto, @Res({ passthrough: true }) res: Response) {

...
export class SubmissionsService {
    ...
    async createSubmission(studentId: string, data: { assignmentId: string; content?: string; fileUrl?: string; attachments?: any[] }) {
        ...
        const isClassAssigned = assignment.classId && assignment.class.students.some(s => s.id === studentId);
    ...
    async gradeSubmission(teacherId: string, submissionId: string, data: { grade: number; feedback?: string }) {
    ...
    async getSubmissionsForAssignment(teacherId: string, assignmentId: string) {
        ...
        const studentsInClass = assignment.class?.students || (assignment.student ? [assignment.student] : []);

...
- **Функции**: Управление Токенами, подписками и тарифами.
...
- `Transaction`: История списаний Токенов.
...
- **Unit**: Тесты сервисов (`*.spec.ts`) для проверки бизнес-логики (подсчет Токенов, формирование промптов).
